...
This is a sample template for guardDutyToSlack - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name guarddutytoslack --tail
```
...
```bash
aws cloudformation delete-stack --stack-name guarddutytoslack
```
